...
fun SignUpScreen(
    ...
    Column(
        ...
        TextField(
            ...
            onValueChange = {
                viewmodel.onUserEvent(SignUpUserEvent.SetPassword(it))
            })
        ...
        TextField(
            ...
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Password),
            onValueChange = {
                viewmodel.onUserEvent(SignUpUserEvent.SetPasswordConfirm(it))
            })
        ...
        Box(modifier = Modifier.padding(40.dp, 0.dp, 40.dp, 0.dp)) {
            Button(
                onClick = {
                          viewmodel.onUserEvent(SignUpUserEvent.SaveUser)
                },
